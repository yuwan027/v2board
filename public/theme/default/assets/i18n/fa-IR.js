window.settings.i18n['fa-IR'] = {
  ...
  '我的钱包(仅消费)': 'کیف پول من (فقط خرج کردن)',
  '自动续费': 'تمدید خودکار',
  '充值': 'شارژ کنید',
  '礼品卡': 'کارت هدیه',
  '请输入礼品卡': 'لطفا کد کارت هدیه را وارد کنید',
  '兑换': 'بازخرید',
  ...
  '重置订阅提示信息': 'هنگامی که اشتراک یا حساب شما توسط اشخاص ناشناس لو می رود و مورد سوء استفاده قرار می گیرد، می توانید اطلاعات اشتراک خود را در اینجا تنظیم مجدد کنید تا از ضررهای غیر ضروری جلوگیری کنید.',
  '重置': 'تغییر',
  ...
  '已过期': 'منقضی شده',
  '已用 {used} / 总计 {total}': 'استفاده شده {used} / مجموع {total}',
  '在线设备 {alive_ip}/{device_limit}' : '{alive_ip} آنلاین / {device_limit} دستگاه',
  '重置订阅信息': 'بازنشانی اطلاعات اشتراک',
